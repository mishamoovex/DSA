...
public class OptimizedPriorityQueue<T extends Comparable<T>> {
    ...
    //A dynamic data_structures.list ot track the elements inside the heap
    ...
    //Constructs a priority data_structures.queue with an initial capacity
    public OptimizedPriorityQueue(int size) {
        heap = new ArrayList<>(size);
    }

    //Constructs and initially empty priority data_structures.queue
    public OptimizedPriorityQueue() {
        this(1);
    }

    // Construct a priority data_structures.queue using heapify in O(n) time, a great explanation can be found at:
    ...
    //Priority data_structures.queue construction, O(log(n))
    ...
    //priority in this priority data_structures.queue. If the priority
    //data_structures.queue is empty null is returned.
    public T peek() {
    ...
    //Adds an element to the priority data_structures.queue, the
